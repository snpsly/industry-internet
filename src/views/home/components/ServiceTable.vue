...
const getTableData = () => {
  loading.value = true
  getTableDataApi({ MaxResultCount: 999 }).then((data) => {
    console.log("🚀 ~ getTableDataApi ~ data:", data)
    tableData.value = data.items
    console.log("🚀 ~ getTableDataApi ~   tableData.value:", tableData.value)
    ...
    <el-card v-loading="loading" shadow="never">
      ...
      <div class="table-wrapper">
        <el-table :data="filterData">
          ...
          <el-table-column prop="schemeNode" label="企业名称" align="center">

...
import {
  ...
  getTableDataApi,
  getTableDataApiId
} from "@/api/killerAPPSubscription"
...
const formRules: FormRules<CreateOrUpdateTableRequestData> = {
  username: [{ required: true, trigger: "blur", message: "请输入杀手锏APP订阅数量名" }],
...
const handleDelete = (row: GetTableData) => {
  ElMessageBox.confirm(`正在删除杀手锏APP订阅数量：${row.name}，确认删除？`, "提示", {
  ...
  <div class="app-container">
    <el-card v-loading="loading" shadow="never" class="search-wrapper">
      <el-form ref="searchFormRef" :inline="true" :model="searchData">
        <el-form-item prop="username" label="杀手锏APP订阅数量名">
    ...
    <el-card v-loading="loading" shadow="never">
      <div class="toolbar-wrapper">
        <div>
          <el-button type="primary" :icon="CirclePlus" @click="dialogVisible = true">新增杀手锏APP订阅数量</el-button>
      ...
      <div class="table-wrapper">
        <el-table :data="tableData">
          ...
          <el-table-column prop="applicationIntroduction" label="简介" align="center" />
    ...
    <el-dialog
      ...
      :title="formData.id === undefined ? '新增杀手锏APP订阅数量' : '修改杀手锏APP订阅数量'"
      @closed="resetForm"
      width="30%"
    >
      <el-form ref="formRef" :model="formData" :rules="formRules" label-width="100px" label-position="left">
        ...
        <el-form-item prop="applicationIntroduction" label="简介">

...
const formRules: FormRules<CreateOrUpdateTableRequestData> = {
  username: [{ required: true, trigger: "blur", message: "请输入杀手锏APP在线用户名" }],
...
const handleDelete = (row: GetTableData) => {
  ElMessageBox.confirm(`正在删除杀手锏APP在线用户，确认删除？`, "提示", {
  ...
  <div class="app-container">
    <el-card v-loading="loading" shadow="never" class="search-wrapper">
      <el-form ref="searchFormRef" :inline="true" :model="searchData">
        <el-form-item prop="username" label="杀手锏APP在线用户名">
    ...
    <el-card v-loading="loading" shadow="never">
      <div class="toolbar-wrapper">
        <div>
          <el-button type="primary" :icon="CirclePlus" @click="dialogVisible = true">新增杀手锏APP在线用户</el-button>
    ...
    <el-dialog
      ...
      :title="formData.id === undefined ? '新增杀手锏APP在线用户' : '修改杀手锏APP在线用户'"
      @closed="resetForm"
      width="30%"
    >

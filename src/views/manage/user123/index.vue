...
const formRules: FormRules<CreateOrUpdateTableRequestData> = {
  username: [{ required: true, trigger: "blur", message: "请输入设备名" }],
...
const handleCreateOrUpdate123 = () => {
  ...
  if (formData.value.deviceChannels) {
    formData.value.deviceChannels.push(formDatasb.value)
  } else {
    formData.value.deviceChannels = []
...
const handleDelete123 = (row) => {
  ...
  formData.value.deviceChannels.splice(row.$index, 1)
}
</script>
  ...
  <div class="app-container">
    <el-card v-loading="loading" shadow="never" class="search-wrapper">
      <el-form ref="searchFormRef" :inline="true" :model="searchData">
        <el-form-item prop="username" label="设备名">
    ...
    <el-card v-loading="loading" shadow="never">
      <div class="toolbar-wrapper">
        <div>
          <el-button type="primary" :icon="CirclePlus" @click="dialogVisible = true">新增设备</el-button>
    ...
    >
      <el-form ref="formRef" :model="formData" :rules="formRules" label-width="100px" label-position="left">
        ...
        <el-form-item prop="name" label="设备类型">
          <el-input v-model="formData.equipmentTypeName" placeholder="请输入" />
        </el-form-item>
        ...
        <el-table :data="formData.deviceChannels">
          <!-- <el-table-column type="selection" width="50" align="center" /> -->
          ...
          <el-table-column prop="lastChannelValue" label="最后通道值" align="center" />
